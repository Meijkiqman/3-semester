...
void Hash::testHash()
{
	...
	std::cout << "hash(1113335557) = " << std::endl;

	std::hash<Test> ht;
	Test t{ 1113335557, "test key ex" };
	i = ht(t);

	std::cout << "egen hash verdi: " << i << std::endl;
}

void Hash::TestUnorderedset()
{
	std::hash<Test> ht;
...
void Hash::TestUnorderedMultiset()
{
	...
	std::cout << "Tenk litt over implementeringen i stl: " << std::endl;
